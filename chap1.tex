...
\begin{figure}
    ...
    \begin{tikzpicture}[%
        ...
        \begin{scope}[shift={(4,0)}]
            \draw [fill=black!30] (0,0) node [mypoint] {} -- 
                  (1,0) node [mypoint] {} --
...
\begin{figure}
    ...
    \begin{tikzpicture}[%
        ...
        \begin{scope}[z={(-5mm,-4mm)}]
            ...
            \draw (B) -- (E);
            \draw [fill=black!30] (E) -- (F1) -- (F2) -- cycle;
            \draw [fill=black!30] (G) -- (F1) -- (F2) -- cycle;
            \path (E)  node [mypoint] {} 
                  (F1) node [mypoint] {}
                  (F2) node [mypoint] {};
        ...
        \begin{scope}[shift={(6,0)}]
            ...
            \draw [fill=black!30] (E) -- (F1) -- (F2) -- cycle;
            \draw [fill=black!30] (G) -- (F1) -- (F3) -- cycle;
            \path (E)  node [mypoint] {} 
                  (F1) node [mypoint] {}
                  (F2) node [mypoint] {}
                  (G)  node [mypoint] {};
