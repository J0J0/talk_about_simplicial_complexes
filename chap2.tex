...
\begin{thDef}%
    ...
    \emph{Dimension von $\sigma$} ist gegeben durch $\dim(\sigma) \defeq
    \abs{\sigma}-1$.
    ...
    simplizialen Komplex}. Sind $E'\subset E,\; K'\subset K$ und definiert
    $(E',K')$ selbst einen simplizialen Komplex, so nennen wir $(E',K')$ einen
    \emph{Teilkomplex von $(E,K)$}.
\end{thDef}
